...
def manual(jump_host, zookeeper_urls, zookeeper_ips, kafka_urls, kafka_ips, schemaregistry_ips, zookeeper_port, kafka_port, schemaregistry_port):
    instances=[]
...
def connect_ssh_tunnel_manual(jump_host, zookeeper_ips_urls, zookeeper_port, kafka_ips_urls, kafka_port):
    click.echo(' * connecting to jump host ' + jump_host)
    opts = []
